import { MaterialConverter, MaterialsFactory } from './Stoichiometry';
...
const factory = new MaterialsFactory();
const materialsLibrary = factory.build(conversionDefinitions);

const converter = new MaterialConverter();
console.log(`It take ${converter.oreForFuel(materialsLibrary)} ORE to produce 1 FUEL`);
